...
import { GetCurrencyDetails } from 'src/hooks/admin/types'
...
export function getCurrencyNameById(currencyId: number | string, results: GetCurrencyDetails[]) {
  for (let i = 0; i < results.length; i++) {
    if (results[i].id == currencyId) {
